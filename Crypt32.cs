namespace MsixVerifier
{
    ...
    internal static class Crypt32
    {
        ...
        (
            ...
            [param: Out, MarshalAs(UnmanagedType.U4)] out CryptQueryContentType pdwContentType,
            [param: Out, MarshalAs(UnmanagedType.U4)] out CryptQueryFormatType pdwFormatType,
            [param: Out, MarshalAs(UnmanagedType.SysInt)] out IntPtr phCertStore,
            [param: Out] out CryptMsgSafeHandle phMsg,
            [param: In, MarshalAs(UnmanagedType.SysInt)] IntPtr ppvContext
         );
        ...
        public static extern bool CertVerifyCertificateChainPolicy(
            [param: In] IntPtr pszPolicyOID,
            [param: In] IntPtr pChainContext,
            [param: In] ref CERT_CHAIN_POLICY_PARA pPolicyPara,
            [param: In, Out] ref CERT_CHAIN_POLICY_STATUS pPolicyStatus
        );
    }
